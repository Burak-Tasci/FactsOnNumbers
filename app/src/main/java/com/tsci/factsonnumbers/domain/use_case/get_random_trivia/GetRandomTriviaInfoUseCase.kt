package com.tsci.factsonnumbers.domain.use_case.get_random_trivia
...
class GetRandomTriviaInfoUseCase @Inject constructor(
    private val repository: NumberFactsRepository
){
    operator fun invoke(): Flow<Resource<String>> = flow {
        try {
            emit(Resource.Loading())
            val info = repository.getRandomTriviaInfo()
